  ...
  return (
    <>
      <Page title='Categories' backPage='/hint' nextPage='/setting'>
        <p className='text-gray-800 dark:text-gray-200 capitalize text-lg font-bold flex gap-x-2 mb-6'>
          <PiSelectionBackgroundBold className='text-3xl' />
          you can select single or multiple categories :
        </p>

        <div className='flex flex-col items-center gap-y-2 pr-2 h-[59%] overflow-auto'>
          {categories.map((item) => (
            <button
